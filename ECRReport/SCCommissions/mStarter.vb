...
'*********************************
'Developed By:  Daniel Foster
'Date           Nov 2006
'Title:         Commissions Report

'VERSIONS
'1.01   - First Version after testing was complete
'1.02   - Fixed problem with multiple client network
'1.03   - Fixed uninstall bug caused by above fix
'1.04   - Fixed sundry label update issue as noticed by Richard Ackerman
'1.05   - 19/02/07 - Fixed Roster/Logged error in the Crystal Report as noticed by Richard Ackerman
'1.06 - 1.13 - July 07/Aug 07 - Version 2 BETA builds
'2.00   - See txt file
...
'Module mStarter
'    Public sVersion As String = "V.2.19" 'Program Version
'    Public sVersionMinor As String = "0019" 'Program Version
'    Public fPinScreen As New fPinScreen   'Main form
